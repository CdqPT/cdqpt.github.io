...
---
建立一个简单的urdf模型。<!-- more -->
详解请参看[教程](http://wiki.ros.org/urdf/Tutorials/Building%20a%20Visual%20Robot%20Model%20with%20URDF%20from%20Scratch)，教程写的非常好，这里只做最终版解析部分。
...
```
![image.png](https://upload-images.jianshu.io/upload_images/16115686-b13bbccdafcbed49.png?imageMogr2/auto-orient/strip%7CimageView2/2/w/1240)
# 二、进阶模型
## 2.1 修改urdf文件
```html
<?xml version="1.0"?>
...
`
## 2.2 运行launch文件
![image.png](https://upload-images.jianshu.io/upload_images/16115686-68948385b842f4e1.png?imageMogr2/auto-orient/strip%7CimageView2/2/w/1240)
